...
window.AllyOSGovReport = (function () {
  ...
  function build(pl){
    ...
    return {
      ...
      content:content,
      styles:{coverTitle:{fontSize:20,bold:true,color:NAVY,alignment:'center',margin:[0,0,0,6]},subtitle:{fontSize:10,color:SLATE,alignment:'center'},sectionTitle:{fontSize:13,bold:true,color:NAVY,margin:[0,14,0,6]},body:{fontSize:9.5,color:INK,lineHeight:1.25}},
