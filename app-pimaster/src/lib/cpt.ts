...
export const IMAGING_GROUPS: ImagingGroup[] = [
  {
    ...
    label: "Spine",
    items: [
      { id: "spine-cervical", label: "Cervical Spine (complete)", cpt: "72052" },
      { id: "spine-thoracic", label: "Thoracic Spine", cpt: "72072" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "upper-wrist", label: "Wrist", cpt: "73110", sided: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "lower-knee", label: "Knee (3 views)", cpt: "73562", sided: true },
      { id: "lower-tibfib", label: "Tibia/Fibula", cpt: "73590", sided: true },
      { id: "lower-ankle", label: "Ankle", cpt: "73610", sided: true },
