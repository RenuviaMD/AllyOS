---
slug: growth-stack
name: Growth Stack (Sermorelin + Ipamorelin)
brand_names: []
axis: Growth
status: investigational
controlled: false
pricing:
  trial: { usd: 595, duration_weeks: 6, cogs_usd: 180 }
  full:  { usd: 1095, duration_weeks: 12, cogs_usd: 330 }
popup_summary:
  mechanism: "GH-axis pair — GHRH analog (Sermorelin) + ghrelin/GHSR agonist (Ipamorelin) for synergistic pulsatile GH"
