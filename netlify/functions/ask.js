...
// AllyOS BHRT / Women's Hormone Wellness provider CDS module (DRAFT v1.5 — MD
// sign-off pending; 4/18 citations PubMed-verified). Grounds every BHRT answer:
  ...
  const system = [
    ...
    },
    {
      ...
      text:
        ...
        "\n\n# BHRT / WOMEN'S HORMONE WELLNESS MODULE (AllyOS provider CDS — DRAFT v1.5, MD sign-off pending; answer ALL BHRT questions from this)\n" +
        ...
        "EVIDENCE/HONESTY: FDA-approved options before compounded (compounded = INTERNAL_FORMULARY + PURPLE exception, no superiority/safety claim). Testosterone is HSDD-ONLY (suppress for energy/mood/cognition/weight/anti-aging/GLP-1/muscle); pellets and oral testosterone are suppressed. Uterus intact + systemic estrogen → an evidence-based progestogen is REQUIRED; uterus unknown → suppress the final systemic-estrogen plan. Every material recommendation carries an evidence source class; no verified source = recommendation suppressed. This module is a DRAFT pending final lock + Medical Director sign-off — 10 of 18 sources are now verified: PubMed-verified are S1/S2/S4/S5/S6/S7/S9/S15 (NAMS HT 2022 + nonhormone 2023, ACOG compounded-BHT 2023, AUA/SUFU/AUGS GSM 2025, ISSWSH + Global testosterone consensus, ACOG 734 postmenopausal-bleeding, PROT-AGE), and web-verified are S8 (NICE NG23) + S10 (FDA fezolinetant liver Boxed Warning); the clinical recommendation backbone is verified. Still pending: S3 (Endocrine Society compounded — not found as labeled; relabel to NASEM 2020) and the standing regulatory/lifestyle/statute refs S11–S14/S16–S18 — flag any reliance on a PENDING source with 'VERIFY (source pending lock)'. Always note BHRT recommendations are draft decision-support and the prescriber owns the decision and signature.\n" +
        "If a BHRT item is not in this module, say 'VERIFY — not in the BHRT module (draft)' rather than guessing.\n\nBHRT MODULE (DRAFT):\n" + BHRT,
      cache_control: { type: "ephemeral" },
    },
  ];
